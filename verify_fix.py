...
def test_prediction():
    ...
    try:
        # Try loading with compile=False and custom objects if needed
    ...
    if os.path.exists(TEST_IMAGE_PATH):
        ...
        # MobileNetV3Large needs specific preprocessing
        ...
        if label == "healthy":
            print("SUCCESS: The model correctly identified the healthy leaf!")
        else:
            print("FAILURE: The model still misclassifies the bright healthy leaf as diseased.")
    else:
